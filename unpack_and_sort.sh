...
# Extract compressed files and move them to the rubbish bin
find "$search_dir" -type f \( -iname "*.zip" -o -iname "*.tar" -o -iname "*.tar.gz" -o -iname "*.tar.bz2" \) -print0 | while read -r -d $'\0' file; do
